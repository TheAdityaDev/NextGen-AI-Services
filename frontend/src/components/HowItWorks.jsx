...
const STEPS = [
  {
    ...
    headingStatic: 'Install NextGen AI Services in',
  ...
  },
  {
    ...
    desc: 'NextGen AI Services automatically responds to common customer queries, resolves repetitive tickets, and assists your team in real time.',
    img: hiv3,
...
const HowItWorks = () => (
  <section className="hiw" id="how-it-works">
    ...
    <p className="hiw__subheading">
      Get NextGen AI Services running in minutes, not hours
    </p>
